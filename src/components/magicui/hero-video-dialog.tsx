  ...
  return (
    <div className={cn("flex items-center justify-center mx-auto w-full", className)}>
      <button
        ...
        className="group flex mx-auto cursor-pointer border-0 bg-black/10 hover:bg-black/20 transition-colors duration-300 ease-in-out rounded-md relative overflow-hidden"
      ...
      <AnimatePresence>
        {isVideoOpen && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 rounded-2xl backdrop-blur-md"
          >
            <motion.div
              {...selectedAnimation}
